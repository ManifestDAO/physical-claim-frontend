...
const Home = () => {
  ...
  return (
    <div className="wrap parent-flex">
      {showFormModal && <ContactForm setShowContactForm={setShowFormModal} />}
      {!showFormModal && (
        <>
          <div
            ...
            onMouseLeave={() =>
              setTimeout(() => setIsManifestShown(false), 500)
            }
          >
            <div className="img">
              <RatioImage />
            ...
            <div className="copy-container">
              <div className="copy-container-content">
                ...
                <p>
                  ...
                  expression in the real world or a streetwear company looking
                  to break into web3.
                </p>
              </div>
            </div>
          ...
          >
            ...
            <div className="copy-container">
              <div className="copy-container-content">
                ...
                <p>
                  Digital copies of real world luxury items that are redeemable
                  for the physical equivalent. Instant markets using automated
                  market makers (AMMs) for physical goods. (Market coming soon)
                  Luxury IRL and Internet crypto-born brand in Storefront.
                  Redeem physical items using Inventory. We build for the next
                  generation of Humans. Are you ready, traveler?
                </p>
              </div>
            </div>
            {isCreateShown && (
          ...
          <div className="own column parent-flex">
            <div className="img">
              <CubeImage />
            </div>
            <div className="copy-container">
              <div className="copy-container-content">
                ...
                <p>
                  Manifest builds tech & developer tools to allow users to
                  create their own physically claimable NFT shopfronts,
                  cross-chain NFT solutions, and expanding the use-cases for
                  NFTs in the real world and digital crypto world. We’re
                  building right now (Check back later)
                </p>
              </div>
            </div>
          </div>
